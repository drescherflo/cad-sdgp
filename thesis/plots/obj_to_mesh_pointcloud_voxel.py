...
def load_display_obj(file_path):
    ...
    save_visualization_as_png(mesh, "out/02_cone_mesh.png")
    pointcloud = mesh.sample_points_poisson_disk(2000)
    save_visualization_as_png(pointcloud, "out/02_cone_pointcloud.png")
    voxel_grid = o3d.geometry.VoxelGrid.create_from_triangle_mesh(mesh, voxel_size=0.05)
    save_visualization_as_png(voxel_grid, "out/02_cone_voxelgrid.png")
